...
CLI.prototype.deleteGlobals = function() {
  ...
  return this._confirmAction(message).then(function() {
    ...
    self._out.write('Global settings deleted from "' + result[0] + '"\n');
  });
};
...
CLI.prototype.deleteService = function(service) {
  ...
  return this._confirmAction(message).then(function() {
    ...
    self._out.write('Settings for service "' + service + '" deleted from "' + result[0] + '"\n');
  });
};
...
CLI.prototype.deleteAll = function() {
  ...
  return this._confirmAction(message).then(function() {
    ...
    self._out.write('All settings deleted from "' + result[0] + '"\n');
  });
};
