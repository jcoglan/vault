(function(factory) {
  var isNode = (typeof require === 'function'),
      ...
      Store = factory(crypto, async, Vault, Cipher, RemoteStore);
...
})(function(crypto, async, Vault, Cipher, RemoteStore) {

var Store = function(adapter, key, options) {
  this._adapter = adapter;
  this._cipher  = new Cipher(key, {format: 'base64', salt: Vault.UUID, work: 100});
