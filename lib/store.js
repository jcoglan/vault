...
Store.prototype.listServices = function() {
  return future.findRecursive(this._storeroom, SERVICE_DIR);
};
...
Store.prototype.export = function() {
  ...
  return storeroom.get(GLOBAL_ITEM).then(function(global) {
    ...
    return future.findRecursive(storeroom, SERVICE_DIR);
...
Store.prototype.clear = function() {
  ...
  return Promise.all([
    ...
    future.removeRecursive(this._storeroom, SERVICE_DIR)
  ]);
};
